...
public class AccountTransferRequestDto {
	...
	public AccountTransferRequestDto(String bank_tran_id, String fintech_use_num, String req_client_name,
		String cntr_account_num, String req_client_account_num) {
